...
const HelloWorld7: React.FC<Props> = (props) => {
    ...
    //USE REF IDEA
//From a normal html input (an input found in a html field) in order to reach it we need to use useRef (refer to html doc)
//There is an input in html document that should be identified as userIDInput.
//In the html declaration in 'return', you would see <input ref={userIdInput} type="number" 
